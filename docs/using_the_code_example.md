...
The following example clones the "[Bluetooth&trade; LE Find Me](https://github.com/Infineon/mtb-example-psoc-edge-btstack-findme)" application with the desired name "BluetoothLEFindMe" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-btstack-findme --user-app-name BluetoothLEFindMe --target-dir "C:/mtb_projects"
   ```
